...
- **Subtitle designs:** Choose Focus (mint accents) or Minimal (white). Both use large 96px captions in the 1080p design space, up to three lines per card, gentle fades, and safe lower-screen margins. Short adjacent recognition fragments share a longer card when they fit, without crossing long pauses. Downloadable SRT files retain recognition timing and plain text.
...
- **Audience questions:** Include one short curiosity question midway through the explanation and a brief closing question or reflection without a repeated factual recap. The next section answers the middle question; the closing question encourages a useful action or thought. At most three questions, including an optional opening question, are allowed in a script.
